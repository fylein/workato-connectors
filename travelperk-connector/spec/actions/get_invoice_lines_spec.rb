...
RSpec.describe "actions/get_invoice_lines", :vcr do
  ...
  let(:action) { connector.actions.get_invoice_lines }

  describe "input_fields" do
    subject(:input_fields) { action.input_fields(settings) }
    let(:expected_input_fields) { JSON.parse(File.read("fixtures/actions/get_invoice_lines/input_fields.json")) }
  ...
  describe "output_fields" do
    ...
    let(:expected_output_fields) { JSON.parse(File.read("fixtures/actions/get_invoice_lines/output_fields.json")) }
