...
RSpec.describe "actions/get_list_of_projects", :vcr do

  # Spec describes the most commons blocks of an action. Remove describes that you don't need.
  # Learn more: https://docs.workato.com/developing-connectors/sdk/cli/reference/rspec-commands.html

  subject(:output) { connector.actions.get_list_of_projects(input) }
  ...
  let(:action) { connector.actions.get_list_of_projects }

  describe "execute" do
    subject(:output) { action.execute(settings) }
    let(:expected_output) { JSON.parse(File.read("fixtures/actions/get_projects/output.json")) }
  ...
  describe "input_fields" do
    ...
    let(:expected_input_fields) { JSON.parse(File.read("fixtures/actions/get_projects/input_fields.json")) }
  ...
  describe "output_fields" do
    ...
    let(:expected_output_fields) { JSON.parse(File.read("fixtures/actions/get_projects/output_fields.json")) }
