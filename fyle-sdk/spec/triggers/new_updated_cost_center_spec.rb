...
RSpec.describe 'triggers/new_updated_cost_center', :vcr do
  ...
  subject(:output) { connector.triggers.new_updated_cost_center(input) }
  ...
  let(:trigger) { connector.triggers.new_updated_cost_center }
